...
An earlier fast-track runtime experiment reported approximately **90.9% Random Forest closed-set accuracy**. This remains exploratory until the exact dataset manifest/configuration are re-established. It is not a validated transmitter-intrinsic fingerprinting claim.
